...
public class OwnerRepositoryTest {
  public static class ディレクトリの所有者を変更する場合 {
    ...
    @Test
    public void 新しく設定するディレクトリ所有者のユーザ名が現在設定されているディレクトリ所有者のユーザ名と同一である場合に終了ステータスがfalseであること()
        throws Exception {
    ...
    public void 新しく設定するディレクトリ所有者として存在しないユーザの名前を指定した場合にUserPrincipalNotFoundExceptionが送出されること()
        throws Exception {
      try {
  ...
  public static class ファイルの所有者を変更する場合 {
    ...
    @Test
    public void 新しく設定するファイル所有者のユーザ名が現在設定されているファイル所有者のユーザ名と同一である場合に終了ステータスがfalseであること()
        throws Exception {
    ...
    @Test(expected = UserPrincipalNotFoundException.class)
    public void 新しく設定するファイル所有者として存在しないユーザの名前を指定した場合にUserPrincipalNotFoundExceptionが送出されること()
        throws Exception {
      try {
